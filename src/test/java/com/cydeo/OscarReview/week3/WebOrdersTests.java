package com.cydeo.OscarReview.week3;
...
public class WebOrdersTests {
    ...
    public void loginToWebOrders() {  // the name is UP to you
        ...
        driver.findElement(By.id("ctl00_MainContent_password")).sendKeys("test" + Keys.ENTER); // without locating submit button we directly click enter
    }
...
locate all checkBoxes: I need to find a locator which will show(point) all the checkboxes, after this step I can use findElements() method for multiple WebElements
     */
        ...
        // we need to reLocate the elements of the list again, otherwise we get StaleElementReferenceException
